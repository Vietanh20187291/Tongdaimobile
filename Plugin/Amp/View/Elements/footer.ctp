...
<div class="block-wiget">
    <ul class="ul-wiget">
        <li onclick="gtag_report_conversionsdt()" class="hotline-wiget">
            <a  href="tel:0915705115">
                <img style="width:25px;height:25px" src="https://img.icons8.com/ios-filled/500/ffffff/phone.png"/>
                <span>Gọi ngay</span>
            </a>
        </li>
        <li onclick="gtag_report_conversionzalo()" class="zalo-wiget" id="zalo-wiget">
            <a target="_blank" rel="nofollow" href="https://chat.zalo.me/?phone=0915705115">
                <!-- <img src="https://img.icons8.com/ios-filled/25/ffffff/zalo.png"/> -->
				<img style="width:25px;height:25px" src="https://img.icons8.com/ios-filled/500/ffffff/zalo.png"/>
                <span>Chat Zalo</span></a>

        </li>
        <li onclick="gtag_report_conversionfacebook()" class="face-wiget">
            <a  target="_blank" rel="nofollow" href="https://m.me/MeMart.vn/">
                <img style="width:25px;height:25px" src="https://img.icons8.com/ios-filled/500/ffffff/facebook-messenger--v2.png"/>
...
<div class=" block-wiget-bottom ">
    <div class="wiget-bottom">
        <div class="row" style="display:flex;justify-content:space-around">
                ...
                <a onclick="gtag_report_conversionsdt()" href="tel:0915705115" class="col-3">
				<img style="width:40px;height:40px" src="https://img.icons8.com/ios-filled/00A400/00A400/phone.png"/>
                </a>
                <a onclick="gtag_report_conversionzalo()" class="col-2"  href="https://zalo.me/0915705115" >
				<img style="width:40px;height:40px" src="https://img.icons8.com/ios-filled/500/0068ff/zalo.png"/>
                </a>


                <a onclick="gtag_report_conversionfacebook()" class="col-3" target="_blank" rel="nofollow" href="https://m.me/MeMart.vn/">
				<img style="width:40px;height:40px" src="https://img.icons8.com/ios-filled/500/1877F2/facebook-messenger--v2.png"/>
                </a>
				<a href="" class="col-2"></a>
        </div>
    </div>
