...
<ol class="breadcrumb">
	...
	<li><?php echo $this->Html->link(__('Trang chủ',true),array('plugin'=>false,'controller'=>'pages','action'=>'home','lang'=>$lang),array('title'=>__('Trang chủ',true),'rel'=>'nofollow','escape'=>false))?></li>
	<?php
