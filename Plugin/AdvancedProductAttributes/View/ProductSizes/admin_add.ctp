...
<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('ProductSize',array('id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
		...
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					<tr>
						<th><?php echo $this->Form->label('size',__('Kích cỡ',true))?> <span class="im">*</span></th>
						<td><?php echo $this->Form->input('size',array('class'=>'larger'))?></td>
					</tr>
