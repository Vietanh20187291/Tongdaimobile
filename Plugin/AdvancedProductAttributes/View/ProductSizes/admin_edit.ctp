...
<div id="column_right">
	...
	<div id="content">
		<?php
			echo $this->Form->create('ProductSize',array('id'=>'form','url'=>array('plugin'=>'AdvancedProductAttributes','action'=>'edit','?'=>array('url'=>(!empty($_GET['url']))?urldecode($_GET['url']):'')),'inputDefaults'=>array('label'=>false,'div'=>false)));
