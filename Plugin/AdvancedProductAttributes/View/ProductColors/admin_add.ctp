...
<div id="column_right">
	...
	<div id="action_top">
    	...
    	<ul class="action_top_2">
    		<li><?php echo $this->Html->link('&nbsp;',array('plugin'=>'AdvancedProductAttributes','action'=>'index'),array('title'=>__('Thoát',true),'class'=>'exit','escape'=>false))?></li>
    	</ul> <!-- end .action_top_2 -->
	</div> <!--  end #action_top -->

	<div id="content">
		<?php echo $this->Form->create('ProductColor',array('id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<tr>
						...
						<td><?php echo $this->Form->input('hex',array('class'=>'w52'))?></td>
					</tr>
