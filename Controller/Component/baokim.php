...
class BaokimComponent 
{
	// URL checkout của baokim.vn
	private $baokim_url = 'https://www.baokim.vn/payment/customize_payment/order';		// Dùng khi chạy thật
//	private $baokim_url  = 'http://sandbox.baokim.vn/payment/customize_payment/order';	// Dùng khi test

	// Mã merchante site 
//	private $merchant_id = '670';	// Tai khoan dung de test	
	private $merchant_id = '4243';	// Tai khoan khi web chạy chính thức

	// Mật khẩu bảo mật
//	private $secure_pass = '6def753ccfc94343'; // Dùng để test	
    private $secure_pass = '36c08eae7728da3c'; // Dùng khi web chạy chính thức
...
//		return $redirect_url.$url_params;
	 ...
	 */
	public function verifyResponseUrl($checksum,$customer_email,$customer_name,$total_amount)
	{
// 		$checksum = $checksum;
//		unset($_GET['checksum']);
