<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('FaqCategory',array('id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
		...
		<div class="tab_container">
			...
			<ul class="submit">
				...
				<li><?php echo $this->Html->link(__('Thoát',true),array('action'=>'index'),array('title'=>'Thoát','class'=>'exit'))?></li>
			</ul> <!-- end .submit -->
