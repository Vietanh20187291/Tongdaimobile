...
<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('PostCategory',array('type'=>'file','id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<tr>
						<th><?php echo $this->Form->label('position',__('Vị trí hiển thị',true))?> <span class="im">*</span></th>
						<td><?php echo $this->Form->input('position',array('type'=>'select','options'=>$oneweb_post['category_position'],'empty'=>__('Chọn vị trí hiển thị',true),'class'=>'medium','required'=>true))?></td>
					</tr>
					<?php }else{?>
					<tr>
						<th><?php echo $this->Form->label('parent_id',__('Danh mục cha',true))?></th>
						<td><?php echo $this->Form->input('parent_id',array('type'=>'select','options'=>$a_categories_c,'empty'=>__('Chọn danh mục cha',true),'class'=>'medium','required'=>false))?></td>
					</tr>
					<?php }?>
					<tr>
					...
					<tr <?php if(empty($oneweb_post['category_banner'])) echo ' class="hidden"'?>>
						...
						<td>
							<?php 
								...
								echo $this->Html->tag('span',__('Kích thước',true).": {$oneweb_post['size']['category_banner'][0]} x {$oneweb_post['size']['category_banner'][1]} (px)",array('class'=>'size_img'));
							?>
						</td>
					</tr>
					<tr<?php if(empty($oneweb_post['category_banner'])) echo ' class="hidden"'?>>
