<div id="column_right">
	...
	<div id="content">
		<?php  
			echo $this->Form->create('Banner',array('type'=>'file','id'=>'form','url'=>array('action'=>'edit','?'=>array('url'=>(!empty($_GET['url']))?urldecode($_GET['url']):'')),'inputDefaults'=>array('label'=>false,'div'=>false)));
		...
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<tr>
						<th><?php echo $this->Form->label('image',__('Ảnh',true))?></th>
						<td>
							<?php 
								echo $this->Html->link($this->Html->image('/img/images/banners/'.$this->request->data['Banner']['image'],array('alt'=>$this->request->data['Banner']['name'],'width'=>80)),'/img/images/banners/'.$this->request->data['Banner']['image'],array('title'=>$this->request->data['Banner']['name'],'class'=>'preview','target'=>'_blank','escape'=>false)).'<br />';
					...
					<tr>
						...
						<td><?php echo $this->Form->input('page',array('type'=>'select','options'=>$oneweb_banner['page'],'class'=>'larger','multiple'=>true))?></td>
					</tr>
