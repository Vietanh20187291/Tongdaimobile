...
<article class="row">
	<div class="col-xs-12">
		...
		<div class="box_info_page">
			<header class="title">
				<h1><span class="title font-weight-bold"><?php echo $title_for_layout?></span></h1>
			</header>
		...
		<div class="box_content list_post">
			...
			<div class="row">
				...
				<div class="paginator">
					<?php
						$url = array('controller'=>'posts','action' => 'index','lang'=>$lang,'position'=>$a_category_c['position']);
