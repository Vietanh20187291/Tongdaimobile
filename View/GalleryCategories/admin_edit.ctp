<div id="column_right">
	...
	<div id="content">
		<?php 
			echo $this->Form->create('GalleryCategory',array('id'=>'form','url'=>array('action'=>'edit','?'=>array('url'=>(!empty($_GET['url']))?urldecode($_GET['url']):'')),'inputDefaults'=>array('label'=>false,'div'=>false)));
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					<tr>
						...
						<td><?php echo $this->Form->input('name',array('class'=>'larger','onchange'=>'getFieldByName("GalleryCategory")'))?></td>
					</tr>
					<tr>
