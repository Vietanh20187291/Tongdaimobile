...
<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('ProductCategory',array('type'=>'file','id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<tr>
						...
						<td><?php echo $this->Form->input('parent_id',array('type'=>'select','options'=>$a_categories_c,'empty'=>'Chọn danh mục cha','class'=>'medium'))?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $this->Form->checkbox('show_in_home',array('checked'=>true))?></td>
					</tr>
