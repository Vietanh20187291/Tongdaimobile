			...
			<tr id="<?php echo 'item_'.$item_category['id']?>">
				...
				<td>
					<?php
						...
						echo $this->Html->link($this->Text->truncate($item_category['name'],50,array('extact'=>false)),array('controller'=>'products','action'=>'index','?'=>array('category_id'=>$item_category['id'],'view'=>2)),array('title'=>$item_category['name'],'class'=>'tooltip'));
