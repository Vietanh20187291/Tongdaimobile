	...
	<div class="col-xs-12 text-center">
		<div class="row">
			<div class="form col-xs-12 col-md-4 col-sm-4 col-sm-offset-4 text-center">
				<h4>
					<b class="text-uppercase"><?php echo __('Tư vấn nhanh',true)?></b>
				</h4>
				...
				<div class="form-group">
					<?php
						echo $this->Form->label('address',__('Khu vực bạn đang sống',true).' <span class="im">(*)</span>');
						echo $this->Form->input('address',array('type'=>'select', 'options'=>array('Hà Nội'=>'Hà Nội', 'TP.Hồ Chí Minh'=>'TP.Hồ Chí Minh', 'Khác'=>'Khác'),'empty'=>'Lựa chọn', 'required'=>true, 'class'=>'form-control'))
					?>
				</div>
				<div class="form-group">
					<?php
						echo $this->Form->label('product_name',__('Sản phẩm cần tư vấn',true));
						...
						echo $this->Form->input('type',array('type'=>'hidden','value'=>'registv','class'=>'form-control'))
					?>
				</div>
				<div class="form-group">
				</div>
