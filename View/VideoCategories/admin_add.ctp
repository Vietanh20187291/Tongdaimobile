<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('VideoCategory',array('id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					<tr>
						...
						<td><?php echo $this->Form->input('name',array('class'=>'larger','onchange'=>'getFieldByName("VideoCategory")'))?></td>
					</tr>
					<tr>
