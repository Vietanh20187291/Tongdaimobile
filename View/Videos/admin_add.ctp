...
<div id="column_right">
	...
	<div id="content">
		<?php echo $this->Form->create('Video',array('id'=>'form','inputDefaults'=>array('label'=>false,'div'=>false)))?>
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<tr>
						...
						<td>
							<?php 
								echo $this->Form->input('video_category_id',array('type'=>'select','options'=>$a_list_categories_c,'empty'=>__('Chọn danh mục',true),'class'=>'medium','required'=>true));
					...
					<tr>
						...
						<td><?php echo $this->Form->input('youtube',array('class'=>'larger'))?></td>
					</tr>
