...
<article class="box_content">
	<header class="title">
		<div class="title_right">
			<div class="title_center">
				...
				<?php
					$url = array('controller'=>'videos','action' => 'index','lang'=>$lang,'slug0'=>$a_category_c['slug']);
				...
				<ul class="sort">
					...
					<li><?php echo $this->Paginator->sort('name',__('Tên'),array('title'=>__('Tên',true),'rel'=>'nofollow','class'=>'tooltip'))?></li>
				</ul> <!--  end .sort -->
	...
	<div class="des">
		...
		<?php if(!empty($a_videos_c)){
			echo $this->element('frontend/c_video',array('data'=>$a_videos_c))?>
