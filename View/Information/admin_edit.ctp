...
<div id="column_right">
	...
	<div id="content">
		<?php  
			echo $this->Form->create('Information',array('id'=>'form','url'=>array('action'=>'edit','?'=>array('url'=>(!empty($_GET['url']))?urldecode($_GET['url']):'')),'inputDefaults'=>array('label'=>false,'div'=>false)));
			echo $this->Form->input('id');
			echo $this->Form->input('parent_id_old',array('type'=>'hidden','value'=>$this->request->data['Information']['parent_id']));
		?>
		...
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					...
					<?php if(!empty($this->request->data['Information']['parent_id']) || (empty($this->request->data['Information']['parent_id']) && empty($this->request->data['Information']['position']))){?>
					<tr>
