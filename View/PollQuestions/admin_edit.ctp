...
<div id="column_right">
	...
	<div id="content">
		<?php  
			echo $this->Form->create('PollQuestion',array('id'=>'form','url'=>array('action'=>'edit','?'=>array('url'=>(!empty($_GET['url']))?urldecode($_GET['url']):'')),'inputDefaults'=>array('label'=>false,'div'=>false)));
		...
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				<table class="add">
					<tr>
						<th><?php echo $this->Form->label('name',__('Tên câu hỏi',true))?> <span class="im">*</span></th>
